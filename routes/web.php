...
Route::get('/{simulation}/play-week', [SimulationController::class, 'playWeek'])->name('simulation.playWeek');
Route::get('/{simulation}/play-all', [SimulationController::class, 'playAll'])->name('simulation.playAll');
